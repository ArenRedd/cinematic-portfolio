          ...
          <div className="lg:col-span-5 flex items-center justify-center relative perspective-[1400px]">
            ...
            >
              ...
              <div className="relative overflow-hidden w-full max-w-[390px] aspect-[4/5] bg-black rounded-sm">
                ...
                <img
                  src={aboutImg}
                  alt="Damisetti Shamya Anand"
                  className="w-full h-full object-contain filter brightness-[0.94] contrast-[1.06] saturate-[1.02] group-hover:brightness-105 group-hover:contrast-[1.12] transition-all duration-700 ease-out"
                />
